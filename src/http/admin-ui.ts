  ...
  <main class="page">
    ...
    <section class="main-grid">
      <article class="card connection-card">
        ...
        <details class="advanced-panel"><summary>Tùy chọn tunnel và bảo mật</summary>
        <p class="muted">URL nhanh chứa token bí mật. Không chia sẻ URL và hãy dừng tunnel khi không sử dụng.</p>
